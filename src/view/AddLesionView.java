...
public class AddLesionView {
    public AddLesionView(LesionsController lesionsController, Lesion lesion, int inclusionId, InclusionDaoImpl inclusionDaoImpl, LesionDaoImpl lesionDaoImpl, FileManager fileManager) {
        Parent rootLog = null;
        ...
        viewLoader.setControllerFactory(iC -> new AddLesionController(lesionsController, lesion, inclusionId, inclusionDaoImpl, lesionDaoImpl, fileManager));
