...
public class InclusionDaoImpl implements InclusionDao {
    ...
    public void createInclusionTable() {
        ...
        try {
            ...
            statement.execute("CREATE TABLE IF NOT EXISTS inclusion (id SMALLINT PRIMARY KEY UNIQUE auto_increment," +
                    "idPatient SMALLINT," +
    ...
    public void insert(Inclusion inclusion) {
        ...
        try {
            preparedStatement = connection.prepareStatement("INSERT INTO inclusion (idPatient,teflon,dateInclusion,numAnaPat)" + "VALUES (?, ?, ?, ?)");
            ...
            System.out.println("INSERT INTO inclusion (first_name,last_name)" + "VALUES (?, ?)");
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
